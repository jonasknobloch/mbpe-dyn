...
func cumulatePredictions2(predictions [][2]Entry, groupSize int) ([]float64, []bool) {
...
func evalPredictions(predictions Predictions, groupSize int) ([]float64, []bool) {
	return cumulatePredictions2(flattenPredictions(predictionsToSlice(predictions)), groupSize)
}
