...
func train() {
	...
	trainers := []struct {
		*mbpe.MBPETrainer
		...
		{newTrainer(m000), "mi000_babylm"},
		{newTrainer(m010), "mi010_babylm"},
		{newTrainer(m020), "mi020_babylm"},
		{newTrainer(m030), "mi030_babylm"},
		{newTrainer(m040), "mi040_babylm"},
		{newTrainer(m050), "mi050_babylm"},
		{newTrainer(m060), "mi060_babylm"},
		{newTrainer(m070), "mi070_babylm"},
		{newTrainer(m080), "mi080_babylm"},
		{newTrainer(m090), "mi090_babylm"},
		{newTrainer(m100), "mi100_babylm"},
	}
